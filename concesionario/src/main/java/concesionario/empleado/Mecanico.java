...
public class Mecanico extends JFrame {
	...
	public Mecanico() {
		...
		lblNombre.setBounds(53, 97, 150, 16);
		contentPane.add(lblNombre);
		
		JLabel lblApellido = new JLabel("Apellido\n");
		lblApellido.setBounds(53, 135, 150, 16);
		contentPane.add(lblApellido);
		
		textFieldNombre = new JTextField();
		textFieldNombre.setBounds(231, 92, 228, 26);
		...
		btnRegistrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (datos) {
					System.out.println("DNI: " + textFieldDNI.getText());
				} else {
		...
		textFieldApellido.setBounds(231, 130, 228, 26);
		...
		lblContrasenya.setBounds(53, 260, 150, 16);
		contentPane.add(lblContrasenya);
		
		JLabel lblNickname = new JLabel("Nickname");
		lblNickname.setBounds(53, 305, 150, 16);
		...
		textFieldNick.setBounds(231, 300, 228, 26);
		...
		passwordField.setBounds(231, 255, 228, 26);
